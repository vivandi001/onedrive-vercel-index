...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'ProfiPlus@yb13g.onmicrosoft.com',
  ...
  protectedRoutes: ['/Videos/u-need-a-password', '/🥟 Some test files/Protected route'],
